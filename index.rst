...
Basic knowledge of command line software (e.g. Linux/Unix) is beneficial
(but not required) for the Software Reproducibility workshop.


Learning Outcomes
```````````````````

At these workshops learners will..
